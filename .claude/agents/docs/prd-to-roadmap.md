---
name: "prd-to-roadmap"
description: "Use this agent when a PRD (Product Requirements Document) needs to be analyzed and converted into a structured, actionable ROADMAP.md file for the development team. Examples:\\n\\n<example>\\nContext: The user has a PRD document and wants to create a development roadmap from it.\\nuser: \"여기 PRD가 있어. 이걸 바탕으로 ROADMAP.md를 만들어줘\" (attaches PRD)\\nassistant: \"PRD를 분석하여 ROADMAP.md를 생성하겠습니다. prd-to-roadmap 에이전트를 실행합니다.\"\\n<commentary>\\nThe user has provided a PRD and wants a roadmap. Use the prd-to-roadmap agent to analyze and generate the ROADMAP.md.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user has finished writing a PRD and wants to plan the development phases.\\nuser: \"PRD 작성이 완료됐어. 이제 개발 로드맵을 만들어야 해.\"\\nassistant: \"prd-to-roadmap 에이전트를 사용하여 PRD를 분석하고 ROADMAP.md를 생성하겠습니다.\"\\n<commentary>\\nThe user needs a development roadmap from their completed PRD. Launch the prd-to-roadmap agent.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: A team lead wants to break down a product spec into milestones and sprints.\\nuser: \"제품 스펙 문서를 팀이 실제로 사용할 수 있는 로드맵으로 변환해줘.\"\\nassistant: \"prd-to-roadmap 에이전트를 실행하여 제품 스펙을 실행 가능한 ROADMAP.md로 변환하겠습니다.\"\\n<commentary>\\nConverting a product spec to a roadmap is the core use case for this agent.\\n</commentary>\\n</example>"
